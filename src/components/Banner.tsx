...
export default function Banner(){
        ...
        const arrayImg = ['/img/cover.jpg','/img/cover2.jpg','/img/cover3.jpg','/img/cover4.jpg'];
        ...
        return(
               <div className={styles.banner} onClick={()=>setIndex(index+1)}>
                ...
                Creating memorable experiences in the perfect space.
                </h4>
                </div>
                {
